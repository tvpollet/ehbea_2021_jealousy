...
* One of the core topics studies by evolutionary psychologists (Buss, 1992)
...
???
Due to asymmetries in cost, evolution has shaped 
...
* 152 students completed a vignette study. (Between-subject design). **Key outcome**: Jealousy (1-5 rating)
...
knitr::include_graphics("https://media.giphy.com/media/efF7tKGHvrUg8/giphy.gif")
```
...
Thanks to reviewers, authors for meta-analysis, students, and our participants.
